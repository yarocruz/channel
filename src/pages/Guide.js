            ...
            <div className='guide-container'>
                <div className='guide-container--content'>
                    ...
                    <p>Adding a feed is pretty straight forward. All you need to do is to make sure
                        ...
                        RSS feed link and you can find the link in the navigation. Be aware however some sites bury them in
                    ...
                    <p>To delete a feed simply hover the and click the x. Easy.</p>

                    <h2>How this App is Working</h2>
                    <p>This app is a work in progress. It's using the browser's localStorage to make the feeds you add persist.
                        I added the feature that keeps track of the items you read, but it's currently buggy. I'm hoping
                        to keep adding features. It's built with React. If your a coder and want to collaborate or give me
